    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <div className={styles.dateSelector}>
          <Calendar strokeWidth={1.5} size={18} style={{ color: 'var(--color-text-secondary)' }} />
      ...
      {canWrite && (
        <div className={styles.auditSection}>
          <div className={styles.auditTitle}>
            <ShieldAlert strokeWidth={1.5} size={24} style={{ color: 'var(--color-brand-gold)' }} />
          ...
          <div className={styles.modalContent}>
            <div className={styles.modalHeader}>
              <h2 className={styles.modalTitle} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <AlertTriangle strokeWidth={1.5} size={20} style={{ color: '#E65100' }} />
