...
const ROUTE_PERMISSIONS: Record<string, string[]> = {
  ...
  '/dashboard/rooms': ['settings.rooms.read'],
  '/dashboard/housekeeping': ['housekeeping.read'],
  '/dashboard/maintenance': ['maintenance.read'],
  '/dashboard/guests': ['guests.read'],
  '/dashboard/billing': ['billing.read'],
  '/dashboard/reports': ['reports.read'],
  '/dashboard/profile': [], // Pas de permission requise pour le profil
};
