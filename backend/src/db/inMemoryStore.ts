import { Room, Reservation, BrunchOrder, MaintenanceTicket, Guest, Payment, User } from '../../frontend/src/types';
...
export let mockBrunchOrders: BrunchOrder[] = [
  {
    id: 'CMD-101',
    roomNumber: '204',
...
export let mockMaintenance: MaintenanceTicket[] = [
  {
    id: 'MAINT-001',
    roomNumber: '202',
