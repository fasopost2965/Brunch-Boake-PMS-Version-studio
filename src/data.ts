...
export const BRUNCH_MENU = [
  ...
  { id: 'b2', name: 'Pancakes de la Passion', category: 'Dessert', price: 8500, desc: 'Pancakes moelleux, coulis de fruits de la passion de Bouaké, miel' },
  { id: 'b3', name: 'Le Plateau Brunch Complet', category: 'Plat', price: 18000, desc: 'Boisson chaude, jus frais, assortiment sucré/salé royal' },
  { id: 'b4', name: 'Café de Man (Grand Cru)', category: 'Boisson', price: 3000, desc: 'Café 100% Robusta récolté localement, servi à la presse' },
  { id: 'b5', name: 'Cocktail Bouaké Sun', category: 'Boisson', price: 5000, desc: 'Jus de mangue fraîche, gingembre, citron vert, hibiscus' }
];
